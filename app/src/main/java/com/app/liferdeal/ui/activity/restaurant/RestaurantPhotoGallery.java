...
public class RestaurantPhotoGallery extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getPhotoGalleryData(){
        ...
        Observable<RestaurantGalleryModel> observable = apiInterface.getRestaurantFoodGallery(prefsHelper.getPref(Constants.API_KEY), Constants.LNG_CODE,clickRestId);
